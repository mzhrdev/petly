...
export default function SellerLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { name: "List New Item", href: "/seller/list" },
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col">
        <div className="p-6 border-b border-gray-200">
          <h1 className="text-2xl font-bold text-blue-600">PETLY Seller</h1>
        </div>
      ...
      <main className="flex-1 flex flex-col">
        ...
        <header className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
          <h2 className="text-lg font-semibold text-gray-800">Seller Portal</h2>
          <div className="flex items-center gap-4">
            <span className="text-sm text-gray-600">seller@petly.com</span>
